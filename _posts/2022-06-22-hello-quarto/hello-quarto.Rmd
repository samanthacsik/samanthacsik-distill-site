...
```{r, fig.cap = "Catalina Oaida Taglialatela screenshares the NASA Earthdata Cloud Cookbook, which is built using Quarto and accessible at https://nasa-openscapes.github.io/earthdata-cloud-cookbook/"}
# add cover image
