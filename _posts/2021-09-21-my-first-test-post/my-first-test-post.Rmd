...
knitr::include_url("https://www.allisonhorst.com/post/2020-03-02-gt-tables-examples/")
```
...
Now that we're all feeling inspired to flex our creative data science muscles, let's create and customize our own blog posts `r fontawesome::fa("blog", fill = "#93A588", a11y = "sem")`
