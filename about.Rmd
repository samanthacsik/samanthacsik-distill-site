...
title: "about"
description: |
  thanks for stopping by my little corner of the internet! slowly trying to add a bit more about who i am outside of work
output: 
...
<!--html_preserve-->
<iframe src = "sams_hiking_map_ESRITerrain.html", width ="600", height="400"> </iframe>
<!--/html_preserve-->
...
I started recording my hikes on [Strava](https://www.strava.com/) in late 2020 and finally got around to scraping my activity data using the [`rStrava`](https://github.com/fawda123/rStrava) package. Below is a heat map of all my recorded hikes made using [`leaflet`](https://rstudio.github.io/leaflet/). I'm still mulling over a better way to display activity information, as the markers overlap a lot at my most frequented trail heads. Huge shout out to [Daniel Cullen]() (who also happens to be a Santa Barbara resident!) for his awesome [blogpost](https://www.dancullen.me/articles/creating-a-heatmap-in-r-with-google-polylines) that got me started with my own map.
